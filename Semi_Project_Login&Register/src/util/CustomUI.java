...
public class CustomUI extends JFrame {
	...
	public void setPanel() {
		...
		topBluePanel.setBackground(new Color(239, 198, 71));
		backgroundPanel.add(topBluePanel);
		
		JPanel topGrayPanel = new JPanel();
		topGrayPanel.setBounds(0, 70, 420, 50);
		topGrayPanel.setBackground(new Color(247, 220, 138));
		backgroundPanel.add(topGrayPanel);
	}
	
	public JTextField setTextField(String name, String placeholder, int x, int y, int width, int height) {
	...
	protected JButton setBtnBlue(String name, String text, int y) {
		...
		Font btnFont = new Font("맑은 바탕", Font.PLAIN, 20);
		btn.setFont(btnFont);
		btn.setBackground(new Color(53, 121, 247));
	...
	public JButton setBtnYellow(String name, String text, int y) {
...
/*	protected JButton setBtnMovie(String name, String time, String seatCnt, int x, int y) {
	...
	protected JButton setBtnSeat(String name, String seat, int x, int y) {
		...
		Font btnFont = new Font("맑은 바탕", Font.BOLD, 14);
		btn.setFont(btnFont);
		btn.setBackground(new Color(230, 236, 240));
		btn.setForeground(new Color(114, 114, 114));
		btn.setBorderPainted(false);
	...
	protected JButton setBtnImg(String name, String text, int x, int y) {
		...
		Font btnFont = new Font("留묒� 怨좊뵓", Font.PLAIN, 18);
		btn.setFont(btnFont);
		btn.setBackground(new Color(53, 121, 247));
		btn.setForeground(Color.WHITE);
	...
	public JLabel setLb(String name, String text, int x, int y, int width, int height, String alignment, int fontSize, String weight) {
		JLabel lb = new JLabel(text);
		Font lbFont = new Font("留묒� 怨좊뵓", setWeight(weight), fontSize);
		lb.setFont(lbFont);
	...
	protected JLabel setLbBox(String name, String text, int x, int y) {
		...
		if(age == 99) {
			lb.setFont(new Font("留묒� 怨좊뵓", Font.BOLD, 0));
			lb.setBackground(new Color(53, 121, 247));
		} else if(age >= 19) {
			lb.setFont(new Font("留묒� 怨좊뵓", Font.BOLD, 15));
			lb.setBackground(Color.RED);
		} else if (age <= 0) {
			lb.setFont(new Font("留묒� 怨좊뵓", Font.BOLD, 10));
	...
	protected JCheckBox setCheckBox(String name, String text, int x, int y) {
		...
		JLabel lb = new JLabel(text);
		Font lbFont = new Font("留묒� 怨좊뵓", Font.PLAIN, 16);
		lb.setFont(lbFont);
		lb.setForeground(new Color(114, 114, 114));
...
/*	protected JComboBox<Combo> setCombo(String name, Vector<Combo> combos, int x, int y, int width, int height){
		...
		if(combos == null) {
			Combo comboNull = new Combo(0, "�뾾�쓬");
		...
		combo.setFont(new Font("留묒� 怨좊뵓", Font.PLAIN, 15));
	...
	protected JList<Combo> setList(String name, DefaultListModel<Combo> listModel, int x) {
		...
		list.setFont(new Font("留묒� 怨좊뵓", Font.BOLD, 15));
